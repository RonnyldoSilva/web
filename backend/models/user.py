...
class User(ndb.Model):
    ...
    def create_notification_message(self, user_key, current_institution_key, 
        ...
        """ Create message that will be used in the notification. 
            user_key -- The user's key who made the action.
            current_institution -- The institution that user was in the moment that it made the action.
